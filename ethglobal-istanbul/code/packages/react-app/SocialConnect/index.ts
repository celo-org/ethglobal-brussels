...
import FA_CONTRACT from "@celo/abis/FederatedAttestations.json";
import ODIS_PAYMENTS_CONTRACT from "@celo/abis/OdisPayments.json";
import STABLE_TOKEN_CONTRACT from "@celo/abis/StableToken.json";
import {
    FA_PROXY_ADDRESS,
